...
function GuardianLeft() {
  return (
    <div className="w-1/2 flex items-center justify-center flex-shrink-0" style={{ background: '#0a0f0d', minHeight: '420px' }}>
...
function BouzerLeft() {
  return (
    <div className="w-1/2 flex-shrink-0 overflow-hidden" style={{ minHeight: '420px' }}>
...
function Projects() {
  return (
    <section id="work" className="px-6 md:px-10 py-24">
      <p className="text-sm tracking-[0.2em] uppercase text-white/60 text-center mb-16">Selected Works</p>
        ...
        {projects.map((project) => {
          ...
          return (
            ...
            >
              <LeftPanel />
              <div
                className="w-1/2 p-12 md:p-14 flex flex-col justify-between flex-shrink-0"
                style={{ background: project.rightBg }}
              >
                <div>
                  <h2 className="text-3xl font-bold text-black mb-4 tracking-wide uppercase">
                    {project.title}
                  </h2>
                ...
                <a
                  ...
                  className="text-base text-black/70 flex items-center gap-1 mt-8 hover:text-black transition-colors w-fit"
                >
...
function About() {
  return (
    <section id="about" className="px-6 md:px-10 py-20 border-t border-white/10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
        <div>
          <p className="text-sm tracking-[0.15em] uppercase text-white/60 mb-6">About Me</p>
          <p className="text-base text-white/70 leading-relaxed mb-4">
            I&apos;m a third-year design student at university in Bangkok, building toward a career in product design. I care about the details, the transitions that feel off, and the moments that make someone go &ldquo;wow&rdquo;.
          </p>
...
function Footer() {
  return (
    <footer id="contact" className="px-6 md:px-10 py-16 border-t border-white/10">
